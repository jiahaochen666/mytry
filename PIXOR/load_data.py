...
def load_dataset(root='Data/', batch_size=1, train_val_split=0.9, test_set=False,
    ...
    if not test_set:
        ...
        # generated training and validation set, [5832, 649]
...
if __name__ == '__main__':
    ...
    data_loader = load_dataset(root=root_dir, batch_size=batch_size, device=device, show_times=False)

    print(len(data_loader['train']), len(data_loader['val']))
