...
if __name__ == '__main__':
    ...
    for id in ids:
        ...
        checkpoint = torch.load('/checkpoint/ckpt107.pth')
        ...
        final_box_predictions = process_predictions(predictions, confidence_threshold=0.7)
        ...
        print('Index: ', id)
        #Todo
        cv2.imwrite('detection_id_{:d}.png'.format(id), bev_image)